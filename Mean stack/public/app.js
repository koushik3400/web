...
cApp.controller("userRegisterCtrl", [
  ...
  function ($http, $location, getFormData, shareService, $scope) {
    ...
    $scope.populate = function () {
      document.forms["register_form"]["f_name"].value = "Koushik";
      document.forms["register_form"]["l_name"].value = "Ramaraju";
      document.forms["register_form"]["email"].value = "koushik@gmail.com";
      document.forms["register_form"]["pwd"].value = "abcd";
    };
